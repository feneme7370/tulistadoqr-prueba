...
<template>
    ...
    <div class="my-2 px-2 py-1 bg-primary-200 h-full">
...
<style scoped>
    ...
    .card__product-descriptions-tag{
        @apply block whitespace-nowrap  bg-primary-100 text-primary-800 text-xs font-medium my-2 me-2 px-2.5 py-0.5 rounded;
    }
