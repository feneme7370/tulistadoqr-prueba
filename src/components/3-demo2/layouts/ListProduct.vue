                ...
                <div class="relative bg-white p-4 rounded-lg shadow ">
                    ...
                    <div class="w-full">
                        ...
                        <div>
                            ...
                            <input v-model="nameClient" type="text" id="name_client" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg active:outline-none focus:ring-secondary-500 focus:border-secondary-500 block w-full p-2.5" placeholder="Su nombre" />
                        </div>

                        <!-- direccion -->
                        <div>
                            <label for="adress_client" class="block mt-2 text-sm font-medium text-gray-900 ">Direccion</label>
                            <input v-model="adressClient" type="text" id="adress_client" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg active:outline-none focus:ring-secondary-500 focus:border-secondary-500 block w-full p-2.5" placeholder="Su direccion" />
                        </div>

                        <!-- forma de pedir -->
                        <div>
                            <label for="format_client" class="block mt-2 text-sm font-medium text-gray-900 ">Forma del pedido</label>
                            <select v-model="formatClient" id="format_client" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg active:outline-none focus:ring-secondary-500 focus:border-secondary-500 block w-full p-2.5">
                    ...
                    <div>
                        <a :href="'https://api.whatsapp.com/send/?phone='+urlDeWhatsapp+'&amp;text='+encodeURIComponent('\*Quiero pedir:\* \n'+totalWsp+'\n\*Nombre:\* '+nameClient+'\n\*Direccion:\* '+adressClient+'\n\*Metodo:\* '+formatClient+'.')" target="_blank"
                            class="block w-full px-2 py-3 mt-3 text-base font-semibold text-center text-white bg-gray-900 rounded shadow-sm hover:bg-secondary-600">Pedir por Whatsapp</a>
                    </div>
