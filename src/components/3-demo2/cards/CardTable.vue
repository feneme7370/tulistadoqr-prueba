    ...
    <div class="my-2 px-2">
        ...
        <div class="card__product">
            ...
            >
                ...
                <div class="4/12 card__product-descriptions-prices">
...
<style scoped>
    ...
    .card__product-descriptions-tag{
        @apply block whitespace-nowrap  bg-secondary-200 text-secondary-800 text-xs font-medium my-2 me-2 px-2.5 py-0.5 rounded;
    }
