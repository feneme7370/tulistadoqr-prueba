    ...
    <div class="my-2 px-2">
        ...
        <div class="flex justify-center gap-1 my-2 bg-primary-100 text-gray-700 min-h-28">
            ...
            <div
                ...
                <span v-for="tag in product.tags" class="block whitespace-nowrap  bg-primary-200 text-primary-900 text-xs font-medium  my-2 me-2 px-2.5 py-0.5 rounded">{{ tag.name }}</span>
